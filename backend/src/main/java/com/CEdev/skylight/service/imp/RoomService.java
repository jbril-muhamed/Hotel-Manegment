package com.CEdev.skylight.service.imp;

import com.CEdev.skylight.dto.Response;
import com.CEdev.skylight.dto.RoomDTO;
import com.CEdev.skylight.entity.Room;
import com.CEdev.skylight.exception.OurException;
import com.CEdev.skylight.repo.RoomRepository;
import com.CEdev.skylight.service.LocalStorageService;
import com.CEdev.skylight.service.interfac.IRoomService;
import com.CEdev.skylight.utils.Utils;
...
public class RoomService implements IRoomService {
    ...
    public Response addNewRoom(MultipartFile photo, String roomType, BigDecimal roomPrice, String description) {
        ...
        try {
            String imageUrl = localStorageService.saveImageLocally(photo);
            Room room = new Room();
    ...
    public Response updateRoom(Long roomId, String description, String roomType, BigDecimal roomPrice,
        ...
        try {
            ...
            if (photo != null && !photo.isEmpty()) {
                imageUrl = localStorageService.saveImageLocally(photo);
            }
